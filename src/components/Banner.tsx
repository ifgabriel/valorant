...
const Banner = () => (
  <section className="relative after:absolute after:left-[19rem] after:top-0 after:h-full after:border-l after:border-r after:border-r-neutral-400 after:px-40">
